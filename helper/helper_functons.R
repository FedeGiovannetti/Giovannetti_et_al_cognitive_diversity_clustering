...
feature_rename = function(data){
    ...
    data %>% 
      mutate(Feature = case_when(
        Feature == "ANT_correct_trials_amount_congruent" ~ "ANT_Correct congruent trials",    
        Feature == "ANT_correct_trials_amount_incongruent"  ~ "ANT_Correct incongruent trials",
        Feature == "ANT_omitted_trials_amount_congruent" ~ "ANT_Omitted congruent trials",
        Feature == "ANT_omitted_trials_amount_incongruent" ~"ANT_Omitted incongruent trials",
        Feature == "ANT_median_rt_correct_congruent" ~ "ANT_RT congruent trials",      
        Feature == "ANT_median_rt_correct_incongruent" ~ "ANT_RT incongruent trials",
        Feature == "ANT_rt_alerta" ~ "ANT_Alerting network",                        
        Feature == "ANT_rt_ejecutiva" ~ "ANT_Executive network",
        Feature == "ANT_rt_orientacion" ~ "ANT_Orienting network",
        Feature == "CORSI_correct_trials_amount" ~ "CORSI_Correct trials",
        Feature == "CORSI_rt_median_correct" ~ "CORSI_Execution time correct trials",              
        Feature == "CORSI_rt_median_incorrect" ~ "CORSI_Execution time incorrect trials",
        Feature == "TOL_correct_trials_amount" ~ "TOL_Correct trials",           
        Feature == "TOL_rt_planning_median_correct" ~ "TOL_Planning time correct trials",       
        Feature == "TOL_rt_planning_median_incorrect" ~ "TOL_Planning time incorrect trials", 
        Feature == "KBIT_correct_trials_amount" ~ "KBIT_Correct trials"
        )
      )
...
feature_order = c("ANT_Correct congruent trials",
                  "ANT_Correct incongruent trials",
                  ...
                  "CORSI_Correct trials",
                  "CORSI_Execution time correct trials",              
                  "CORSI_Execution time incorrect trials",
                  "TOL_Correct trials",           
